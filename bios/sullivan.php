...
<head>
	...
	<title>Jackie Sullivan | Tennessee Risk Management Trust</title>
...
<div class="fb-bio">
	...
	<div class="bio-text">
		...
		<h1>Jackie Sullivan</h1>

		<h2>Claims Representative</h2>

		<a class="textlink phone-link" href="tel:16156518625">(615) 651-8625 x330</a>
		...
		<h3>Born and raised in Lancaster, South Carolina, Jackie moved to Nashville in 2000 to work for the Trust’s workers’ compensation department. She then worked in the liability department before making a move to focus on student athletic claims. </h3>

		<h2>Did You Know?</h2>

		<h3>In addition to making custom pieces of jewelry and teaching herself to play the violin, Jackie is part of an urban wildlife rescue program and is passionate about helping stray and injured animals.</h3>

		<a class="textlink" href="mailto:jsullivan@tnrmt.com">Email Jackie</a>
